...
execute as @e[scores={HangmanRound=1,HangmanSetup=190}] run setblock 1000 64 -6 oak_sign[rotation=0]{Text1: "{\"text\":\"Hint\"}",Text2: "{\"text\":\"---------------\"}",Text3: "{\"bold\":true,\"text\":\"BLOCK\"}",Text4: "{\"text\":\"    \"}"}
...
execute as @e[scores={HangmanRound=2..5,HangmanSetup=125}] run setblock 1000 64 -6 oak_sign[rotation=0]
